...
export const EditorialBentoGrid: React.FC<EditorialBentoGridProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between border-b border-[#242A38] pb-6 gap-4">
        <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5 auto-rows-[minmax(180px,auto)]">
        ...
        <div
          ...
          className="group relative overflow-hidden rounded-2xl p-6 bg-gradient-to-br from-[#1E163B] via-[#111122] to-[#0A0B14] border border-[#4F46E5]/40 hover:border-[#818CF8]/70 transition-all duration-200 ease-out hover:-translate-y-0.5 shadow-sm hover:shadow-md flex flex-col justify-between cursor-pointer"
        >
        ...
        <div
          ...
          className="group relative overflow-hidden rounded-2xl p-6 bg-gradient-to-br from-[#2D160C] via-[#140E0B] to-[#0D0A0A] border border-[#EA580C]/40 hover:border-[#F97316]/70 transition-all duration-200 ease-out hover:-translate-y-0.5 shadow-sm hover:shadow-md flex flex-col justify-between cursor-pointer"
        >
        ...
        <div
          ...
          className="group relative overflow-hidden rounded-2xl p-6 bg-gradient-to-br from-[#2F0F18] via-[#140B0F] to-[#0A0709] border border-[#E11D48]/40 hover:border-[#FB7185]/70 transition-all duration-200 ease-out hover:-translate-y-0.5 shadow-sm hover:shadow-md flex flex-col justify-between cursor-pointer"
        >
        ...
        <div
          ...
          className="md:col-span-2 lg:col-span-2 group relative overflow-hidden rounded-2xl p-6 sm:p-7 bg-gradient-to-br from-[#0F2B20] via-[#0C1613] to-[#080E0C] border border-[#10B981]/40 hover:border-[#34D399]/70 transition-all duration-200 ease-out hover:-translate-y-0.5 shadow-sm hover:shadow-md flex flex-col justify-between"
        >
        ...
        <div
          ...
          className="group relative overflow-hidden rounded-2xl p-6 bg-gradient-to-br from-[#0B252C] via-[#09161B] to-[#060D10] border border-[#06B6D4]/40 hover:border-[#22D3EE]/70 transition-all duration-200 ease-out hover:-translate-y-0.5 shadow-sm hover:shadow-md flex flex-col justify-between cursor-pointer"
        >
        ...
        <Link
          ...
          className="group relative overflow-hidden rounded-2xl p-6 bg-gradient-to-br from-[#33230B] via-[#171107] to-[#0D0A04] border border-[#F59E0B]/50 hover:border-[#FBBF24]/70 transition-all duration-200 ease-out hover:-translate-y-0.5 shadow-sm hover:shadow-md flex flex-col justify-between"
        >
      ...
      {featuredThread && (
        <div className="mt-6 p-4 sm:p-5 rounded-xl bg-[#12151F] border border-[#272D3E] flex flex-col sm:flex-row items-center justify-between gap-4">
